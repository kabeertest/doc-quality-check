...
def main():
    ...
    if 'page_data' in st.session_state and st.session_state.page_data:
        ...
        for page_info in st.session_state.page_data:
            ...
            # Calculate confidence metric with timing (using superfast mode for better performance)
            ocr_conf, confidence_time = calculate_ocr_confidence(page_info['image'], mode='superfast')
            ...
            for page_info in st.session_state.page_data:
                ...
                if TESSERACT_AVAILABLE:
                    try:
                        ...
                        text, _ = extract_text_content(page_info['image'], mode='superfast')
